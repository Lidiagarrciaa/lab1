...
void render()
{
    ...
    //if the window is smaller than the box -> delete
    //else if the window gets smaller make it "hot"
    if (g.xres < 40) {
        glColor3ub(30, 30, 30);  //terminal color
    }
    else if (g.xres < 400) {
        glColor3ub(255, 100, 100); //light red
    }
    else {
        glColor3ub(100, 120, 220); // regular color
    }
